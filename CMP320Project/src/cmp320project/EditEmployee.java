...
public class EditEmployee extends javax.swing.JFrame {
     ...
     */
    public EditEmployee(LoginUser _user, Menu _menu) {
    ...
    private void getNewData() {
        ...
        try {
            ...
            rs = dbCon.executeStatement("SELECT A.name, A.username, A.email, E.employeeType FROM account A, employee E WHERE A.username = E.username AND A.username = '" + user.username + "' ORDER BY A.name ASC ");
