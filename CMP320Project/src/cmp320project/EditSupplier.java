...
public class EditSupplier extends javax.swing.JFrame {
     ...
     */
    public EditSupplier(LoginUser _user, Menu _menu) {
    ...
    private void getNewData() {
        ...
        try {
            ...
            rs = dbCon.executeStatement("SELECT A.name, A.username, A.email, E.companyname FROM account A, supplier E WHERE A.username = E.username AND A.username = '" + user.username + "' ORDER BY A.name ASC ");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(lblCNameError, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(50, 50, 50)
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            ...
            if (isValidAll() && (!isDuplicate(txtUsername.getText().trim()) || ogUsername.equalsIgnoreCase(txtUsername.getText()))) {
                ...
                String prepSQL1 = "UPDATE supplier SET companyname = '" + txtCName.getText().toLowerCase() +
                "' WHERE username = '" + ogUsername + "'";
